...
public class CountBuilderTest {
	...
	private static class TestCountBuilder<T> extends CountBuilder<T> {
		public TestCountBuilder(boolean distinct, Class<T> entityClass) {
	...
	public void testQueryBuilder() {
		...
		Assert.assertEquals("SELECT COUNT(t) FROM TestEntity t", countBuilder.getQueryString());
		
		countBuilder = new TestCountBuilder(true, TestEntity.class);
		Assert.assertEquals("SELECT COUNT(DISTINCT t) FROM TestEntity t", countBuilder.getQueryString());
	}
	// =========================================================================
}
